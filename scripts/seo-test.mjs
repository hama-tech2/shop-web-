...
check('and a description', (head(home, /name="description" content="([^"]*)"/) || '').length > 0, true);
check('and a canonical link', Boolean(head(home, /rel="canonical" href="([^"]*)"/)), true);
...
check('available, which is all this app knows',
