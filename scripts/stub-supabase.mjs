...
http.createServer(async (req, res) => {
  ...
  if (table === 'products') {
    ...
    if (!write) {
      ...
      // The Home feed asks for ?visibility=eq.everyone. PostgREST
  ...
  // row shape the products table gives — including the currency and
  // visibility columns. Search deliberately includes profile-only rows.
