-- ============================================================
-- Shop Web — a product is shown on Home, or kept off Home.
--
...
--                                             the Home feed as well as
--                                             search, shop and direct URL
--
...
--     URL and Search keep working and the row is still public data. Nothing about
...
comment on column public.products.visibility is
  'everyone = Home feed, search, shop profile and direct link; profile = '
  'search, shop profile and direct link, but not the Home feed. Independent '
  'of status: a profile-only product '
